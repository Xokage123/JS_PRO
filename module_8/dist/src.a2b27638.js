...
var _index2 = _interopRequireWildcard(require("./components/index.js"));
...
maskNumberInput.mask(_index2.default.form.inputs.number.element); // console.log(JustValidate);
...
var checkInput = function checkInput(ev, value) {
  ...
  switch (nameInput) {
    case _index.nameInputs.number:
      checkValue = valueInput;
      break;

    case _index.nameInputs.CVC:
      valueInput.length <= 3 ? checkValue = valueInput : null;
      break;

    case _index.nameInputs.date:
...
var validateAllInputs = function validateAllInputs(inputs) {
  var check = true;

  for (var name in inputs) {// !inputs[name] ? check = false : null;
  }
...
var _loop = function _loop(nameInput) {
  _index2.default.form.inputs[nameInput].element.addEventListener('input', function (ev) {
    _index2.valueInputs[nameInput] = checkInput(ev, _index2.valueInputs[nameInput]);
    _index2.default.form.buttons.submit.element.disabled = validateAllInputs(_index2.valueInputs) ? false : true;
  });
};

for (var nameInput in _index2.default.form.inputs) {
  _loop(nameInput);
}

_index2.default.form.element.append(_index2.default.form.inputs.number.element, _index2.default.form.inputs.date.element, _index2.default.form.inputs.CVC.element, _index2.default.form.inputs.mail.element, _index2.default.form.buttons.submit.element);

_index2.default.container.element.append(_index2.default.bank.logoContainer.element, _index2.default.bank.nameBank.element, _index2.default.form.element);

(0, _redom.mount)(document.body, _index2.default.container.element);
console.log(_index2.default.form.class[0]);
new JustValidate(".".concat(_index2.default.form.class[0]), {
  rules: (_rules = {}, _defineProperty(_rules, _index.nameInputs.number, {
    required: true,
    function: function _function(name) {
      var realyValue = _index2.default.form.inputs[name].element.inputmask ? _index2.default.form.inputs[name].element.inputmask.unmaskedvalue() : _index2.default.form.inputs[name].element.value;
      return realyValue.length === 16;
    }
  }), _defineProperty(_rules, _index.nameInputs.mail, {
    required: true,
    email: true
  }), _defineProperty(_rules, _index.nameInputs.CVC, {
    required: true,
    function: function _function(name, value) {
      return value.length === 3;
    }
  }), _defineProperty(_rules, _index.nameInputs.date, {
    required: true
  }), _rules),
  messages: (_messages = {}, _defineProperty(_messages, _index.nameInputs.number, {
    required: 'Данное поле обязательно для заполнения',
    function: 'Вы ввели меньше 16 обязательных символов'
  }), _defineProperty(_messages, _index.nameInputs.mail, {
    required: 'Данное поле обязательно для заполнения',
    email: 'Вы ввели некорректную электронную почту'
  }), _defineProperty(_messages, _index.nameInputs.CVC, {
    required: 'Данное поле обязательно для заполнения',
    function: 'Вы ввели меньше 3 обязательных символов'
  }), _defineProperty(_messages, _index.nameInputs.date, {
    required: 'Данное поле обязательно для заполнения'
  }), _messages)
});
},{"redom":"node_modules/redom/dist/redom.es.js","inputmask":"node_modules/inputmask/dist/inputmask.js","./data/index.js":"src/data/index.js","./components/index.js":"src/components/index.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
